...
import { ArviemFormControl } from './models/form.model';
...
export class FormControlInjectorDirective implements OnInit, AfterViewInit {
  ...
  private control!: ArviemFormControl;
  private errorMessage$ = new Subject<string>();

  constructor(private readonly el: ElementRef, private readonly formControlName: FormControlName) {}

  ngOnInit(): void {
    const control = this.formControlName.control as unknown as ArviemFormControl;
